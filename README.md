...
| ![Microsoft XDR](https://img.shields.io/badge/Microsoft%20XDR-Defender%20Suite%20%26%20Sentinel-blueviolet?style=flat&logo=microsoft) **Extended Detection & Response (XDR)** | Udemy Course, Self-led Lab Projects | Worked with Microsoft 365 Defender, Sentinel, and Entra ID. Created DLP policies, ASR rules, alerting policies for email/collaboration, and conditional access policies. Wrote KQL queries for threat detection and log analysis. Simulated use cases in a lab environment to mirror SOC workflows and security policy management. [Projects](https://github.com/wilbcn/BlueTeam/tree/main/Endpoint-Protection/MicrosoftXDR) |
